// SPSA: SPS30 Sensirion Arduino sensor. Script version: 0.3. No BME.

// ######### SET THE DEVICEID ####################
String deviceID = "SPSAXXXX"; // Set Device ID

// ######### SET THE LED PIN ##################### -- usually 8
int ledposition = 8;
...
String month_cov = "";
String dataheader = "counter;datetime;PM1;PM2_5;PM4;PM10;NumPM1;NumPM2_5;NumPM4;NumPM10;PartSize;meta";
String data ="";
String serialdata = "";
...
void loop() 
{
  ...
  if (millis() - previousMillis > interval)
  {
    ...
    // bmeString = "";
    data = String(String(counter)+';'+now.timestamp(DateTime::TIMESTAMP_FULL))+";"+pmString+";"+metaString;
